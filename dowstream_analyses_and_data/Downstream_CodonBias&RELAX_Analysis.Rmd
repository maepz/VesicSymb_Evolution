...
p4<-grid.arrange(p3,Kdistrib,nrow=2,heights = unit(c(10,7), "cm"), widths = unit(c(20), "cm"))
ggsave(file="plot_CDCk.svg", plot=p4,width = 20,units = 'cm')
