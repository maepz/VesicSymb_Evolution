...
# (subset(relax,GivsFL_pval<0.05) %>% nrow) + (subset(relax,RuvsFL_pval<0.05) %>% nrow)
# 
# 
# ggplot(data=subset(relax,GivsFL_pval<0.05 | RuvsFL_pval<0.05))+
#   geom_violin(aes(x=GivsFL_k,y='Givffl'),fill='grey90')+
#   geom_jitter(aes(x=RuvsFL_k,y='Givffl'))+
#   geom_violin(aes(x=RuvsFL_k,y='ruvffl'),fill='grey90')+
#   geom_jitter(aes(x=RuvsFL_k,y='ruvffl'))+
#   scale_x_log10(limits=c(0.001,50),breaks=c(0.1,seq(0,0.6,0.2),1,seq(5,10,5),seq(25,50,25)))
...
# subset(relax2,pval<0.05 & comp %in% c(2,3)) %>% nrow
# test = cbind(subset(relax,GivsFL_pval<0.05)$GivsFL_k, subset(relax2,pval<0.05 & comp %in% c(3))$k)
# ggplot(as.data.table(test))+
#   geom_violin(aes(x=V1,y='v1'))+
#   geom_violin(aes(x=V2,y='v2'))+
#   geom_jitter(aes(x=V1,y='v1'))+
#   geom_violin(aes(x=V2,y='v2'))+
#   geom_jitter(aes(x=V1,y='v2'))+
#     scale_x_log10(limits=c(0.001,50),breaks=c(0.1,seq(0,0.6,0.2),1,seq(5,10,5),seq(25,50,25)))


# relax2$comp<-factor(as.factor(relax2$comp), levels=c('SymvsFL','RuvsFL','GivsFL','GivsRu'))
levels(relax2$comp)<-c('SymvsFL','RuvsFL','GivsFL','GivsRu')


# ggplot()+
#   geom_violin(data=subset(relax2,pval<0.05 & comp %in% c('RuvsFL','GivsFL')),aes(x=k,y=comp),fill='grey90')+
#   geom_point(data=subset(relax2,pval<0.05 & comp %in% c('RuvsFL','GivsFL')),aes(x=k,y=comp))+
#   geom_violin(data=subset(relax,GivsFL_pval<0.05),aes(x=GivsFL_k,y='givffl'),fill='grey90',trim = F)+
#   geom_point(data=subset(relax,GivsFL_pval<0.05),aes(x=GivsFL_k,y='givffl'))+
#   geom_violin(data=subset(relax,RuvsFL_pval<0.05),aes(x=RuvsFL_k,y='ruvffl'),fill='grey90')+
#   geom_point(data=subset(relax,RuvsFL_pval<0.05),aes(x=RuvsFL_k,y='ruvffl'))+
#   scale_x_log10(limits=c(0.001,50),breaks=c(0.1,seq(0,0.6,0.2),1,seq(5,10,5),seq(25,50,25)))
# 
# ggplot(data=subset(relax,comp==3 & pval<0.05), aes(x=k,y='ruvffl'))+
...
subset(df, coregene_id %in% core_nopseudo)$coregene_id %>% unique %>% length
