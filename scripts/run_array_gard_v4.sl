#!/bin/bash 
#SBATCH --job-name=run_array_gard4
...
#SBATCH --array=5,17,43,56,61,66,68,73,76,77,78,81
...
(echo "15"; echo "1"; echo "${PATH_ALN}/aligned_${SAMPLE}.fna"; echo "010010"; echo "2"; echo "2"; echo "${PATH_GARD}/HKY/${SAMPLE}.HKY.gard") | mpirun -np $SLURM_NTASKS HYPHYMPI
